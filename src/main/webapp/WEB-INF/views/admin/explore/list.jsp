...
<spring:message var="adminExploreBulkSelectedMsg" code="admin.explore.bulk.selected" javaScriptEscape="true"/>
<spring:message var="adminExploreConfirmDeleteOneMsg" code="admin.explore.confirm.deleteOne" javaScriptEscape="true"/>
<spring:message var="adminExploreConfirmDeleteBulkMsg" code="admin.explore.confirm.deleteBulk" javaScriptEscape="true"/>
<spring:message var="adminExploreErrorRequestFailedMsg" code="admin.explore.error.requestFailed" javaScriptEscape="true"/>
<spring:message var="adminExploreErrorNoSelectionMsg" code="admin.explore.error.noSelection" javaScriptEscape="true"/>
...
var EXPLORE_LIST_MSG = {
    bulkSelectedTemplate: '${adminExploreBulkSelectedMsg}',
    confirmDeleteOne: '${adminExploreConfirmDeleteOneMsg}',
    confirmDeleteBulk: '${adminExploreConfirmDeleteBulkMsg}',
    requestFailed: '${adminExploreErrorRequestFailedMsg}',
    noSelection: '${adminExploreErrorNoSelectionMsg}'
};
