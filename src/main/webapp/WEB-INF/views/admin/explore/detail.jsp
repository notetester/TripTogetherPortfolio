            ...
            <div style="display:grid;gap:12px;">
                ...
                <div class="adm-summary-grid" style="grid-template-columns:repeat(2, minmax(0, 1fr));margin-bottom:0;">
                    ...
                    <div class="adm-card" style="padding:14px;">
                        ...
                        <div class="adm-field-value" style="font-size:14px;margin-top:4px;"><fmt:formatNumber value="${spot.ratingAvg}" pattern="#,##0.0"/> / <spring:message code="admin.explore.detail.reviewCount" arguments="${spot.reviewCount}"/></div>
                    </div>
                    <div class="adm-card" style="padding:14px;">
                        <div class="adm-summary-label"><spring:message code="admin.explore.detail.likeTags"/></div>
                        <div class="adm-field-value" style="font-size:14px;margin-top:4px;"><spring:message code="admin.explore.detail.likeTagsValue" arguments="${spot.likeCount},${spot.tagCount}"/></div>
                    </div>
                </div>
                <div class="adm-card" style="padding:14px;">
                ...
                <div class="adm-card" style="padding:14px;">
                    ...
                    <div class="adm-field-value-sub" style="font-size:13px;margin-top:4px;"><spring:message code="admin.explore.detail.coordinatesValue" arguments="${spot.latitude},${spot.longitude}"/></div>
                </div>
                <div class="adm-card" style="padding:14px;">
...
var EXPLORE_DETAIL_MSG = {
    maxTagLimit: '<spring:message code="admin.explore.detail.maxTagLimit" javaScriptEscape="true"/>',
    confirmDelete: '<spring:message code="admin.explore.detail.confirmDelete" javaScriptEscape="true"/>',
    confirmBlockReview: '<spring:message code="admin.explore.detail.confirmBlockReview" javaScriptEscape="true"/>',
    requestFailed: '<spring:message code="admin.explore.detail.error.requestFailed" javaScriptEscape="true"/>'
};
