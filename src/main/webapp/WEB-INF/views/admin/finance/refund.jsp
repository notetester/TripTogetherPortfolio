...
<spring:message var="adminFinanceRefundSearchPlaceholderMsg" code="admin.finance.refund.searchPlaceholder"/>
<spring:message var="adminFinanceRefundModalReasonPlaceholderMsg" code="admin.finance.refund.modal.reasonPlaceholder"/>
    ...
    <div class="adm-card" style="padding:14px 16px;margin-bottom:16px;">
        <form method="get" action="${pageContext.request.contextPath}/admin/finance/refund"
            ...
            <input type="text" name="keyword" value="${fn:escapeXml(keyword)}"
                   class="adm-input"
                   placeholder="${adminFinanceRefundSearchPlaceholderMsg}"
...
<div id="adm-fin-refund-modal" class="adm-card"
    ...
    <form id="adm-fin-refund-form" method="post">
        ...
        <textarea name="reason" required minlength="3" maxlength="500"
                  ...
                  placeholder="${adminFinanceRefundModalReasonPlaceholderMsg}"></textarea>
