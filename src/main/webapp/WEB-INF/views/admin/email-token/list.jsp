...
<spring:message var="adminEmailTokensSearchPlaceholderMsg" code="admin.emailTokens.searchPlaceholder"/>
<spring:message var="adminEmailTokensHistoryTitleMsg" code="admin.emailTokens.historyTitle"/>
...
<div class="adm-content">
      ...
      <form method="get" action="${pageContext.request.contextPath}/admin/email-tokens">
        <div class="adm-filter-bar">
          <div class="adm-search-box" style="flex:1;min-width:220px;">
            ...
            <input class="adm-input" type="text" name="keyword" value="${search.keyword}" placeholder="${adminEmailTokensSearchPlaceholderMsg}">
          </div>
          <div>
  ...
  <div class="adm-card">
    <div class="adm-card-head">
      <div class="adm-card-title">${adminEmailTokensHistoryTitleMsg}</div>
...
function openTokenDetail(btn) {
  var d = btn.dataset;
  showRowDetail('${adminEmailTokensHistoryTitleMsg}', [
    ['발급 시각', d.time],
    ['회원', d.user],
    ['목적', d.purpose],
    ['이메일', d.email],
