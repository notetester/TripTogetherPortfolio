                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button"
                                                ...
                                                onclick="focusPackageReviewAction('revision-${revision.packageRevisionIdx}')">${revision.requestedAt}</button>
                                    </td>
                                    <td>
                                        <div class="business-review-actions" id="package-action-revision-${revision.packageRevisionIdx}">
                ...
                <c:forEach var="pkg" items="${packageList}">
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button"
                                    class="adm-cell-link adm-cell-link--inline status-badge ${displayStatusClass}"
                                    onclick="focusPackageReviewAction('package-${pkg.packageIdx}')">
                                <c:choose>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${pkg.packageStatus eq 'PENDING'}">
                                    <div class="business-review-actions" id="package-action-package-${pkg.packageIdx}">
