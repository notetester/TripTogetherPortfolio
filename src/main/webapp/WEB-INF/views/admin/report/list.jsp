...
<spring:message var="adminReportsSearchPlaceholderMsg" code="admin.reports.searchPlaceholder"/>
                ...
                <div class="adm-filter-bar">
                    ...
                    <div style="flex:1;min-width:200px;">
                        ...
                        <div class="adm-search-box">
                            ...
                            <input class="adm-input" type="text" name="keyword" value="${search.keyword}" placeholder="${adminReportsSearchPlaceholderMsg}">
                        </div>
                    </div>
