...
<spring:message var="adminCoursesDetailJsConfirmActionMsg" code="admin.courses.detail.js.confirmAction" javaScriptEscape="true"/>
...
var COURSE_DETAIL_MESSAGES = {
    ...
    confirmAction: '${adminCoursesDetailJsConfirmActionMsg}',
