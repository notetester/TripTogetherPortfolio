...
<%--
  고객지원 - 문의 작성 페이지
  Controller : GET  /inquiry/write  → 폼 표시
               POST /inquiry/write  → @ResponseBody JSON 반환
--%>
<!DOCTYPE html>
<html lang="ko">
  ...
  <div class="inq-write-inner">
    ...
    <div class="inq-write-card">
      ...
      <div class="inq-form-group">
        <label class="inq-form-label" for="category">문의 유형 <span class="inq-required">*</span></label>
      ...
      <%-- 제목 --%>
      <div class="inq-form-group">
        <label class="inq-form-label" for="title">제목 <span class="inq-required">*</span></label>
      ...
      <%-- 내용 --%>
      <div class="inq-form-group">
        <label class="inq-form-label" for="content">내용 <span class="inq-required">*</span></label>
