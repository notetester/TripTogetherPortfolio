...
<spring:message var="superadminPermissionsFormCodePlaceholderMsg" code="superAdmin.permissions.form.codePlaceholder"/>
<spring:message var="superadminPermissionsFormDisplayNamePlaceholderMsg" code="superAdmin.permissions.form.displayNamePlaceholder"/>
<spring:message var="superadminPermissionsFormDescriptionPlaceholderMsg" code="superAdmin.permissions.form.descriptionPlaceholder"/>
<spring:message var="superadminPermissionsModalAdminSearchPlaceholderMsg" code="superAdmin.permissions.modal.adminSearchPlaceholder"/>
<spring:message var="superadminPermissionsToastRequiredMsg" code="superAdmin.permissions.toast.required" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsToastCreateFailedMsg" code="superAdmin.permissions.toast.createFailed" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsToastCreatedMsg" code="superAdmin.permissions.toast.created" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsConfirmActivateMsg" code="superAdmin.permissions.confirm.activate" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsConfirmDeactivateMsg" code="superAdmin.permissions.confirm.deactivate" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsToastUpdatedMsg" code="superAdmin.permissions.toast.updated" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsToastUpdateFailedMsg" code="superAdmin.permissions.toast.updateFailed" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsConfirmDeleteEmptyMsg" code="superAdmin.permissions.confirm.deleteEmpty" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsConfirmDeleteWithUsageMsg" code="superAdmin.permissions.confirm.deleteWithUsage" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsToastDeletedMsg" code="superAdmin.permissions.toast.deleted" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsToastDeleteFailedMsg" code="superAdmin.permissions.toast.deleteFailed" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsModalDetailTitleSuffixMsg" code="superAdmin.permissions.modal.detailTitleSuffix" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsNoGroupsMsg" code="superAdmin.permissions.noGroups" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsNoTemplatesMsg" code="superAdmin.permissions.noTemplates" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsNoAdminsMsg" code="superAdmin.permissions.noAdmins" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsActionRevokeMsg" code="superAdmin.permissions.action.revoke" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsToastSearchRequiredMsg" code="superAdmin.permissions.toast.searchRequired" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsSearchEmptyMsg" code="superAdmin.permissions.searchEmpty" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsActionGrantMsg" code="superAdmin.permissions.action.grant" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsConfirmGrantAdminMsg" code="superAdmin.permissions.confirm.grantAdmin" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsToastGrantedMsg" code="superAdmin.permissions.toast.granted" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsToastGrantFailedMsg" code="superAdmin.permissions.toast.grantFailed" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsConfirmRevokeAdminMsg" code="superAdmin.permissions.confirm.revokeAdmin" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsToastRevokedMsg" code="superAdmin.permissions.toast.revoked" javaScriptEscape="true"/>
<spring:message var="superadminPermissionsToastRevokeFailedMsg" code="superAdmin.permissions.toast.revokeFailed" javaScriptEscape="true"/>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <div class="sa-group-row ${p.active ? '' : 'sa-group-inactive'}">
                        ...
                        <div class="sa-group-cnt"><spring:message code="superAdmin.permissions.list.usageCount"/></div>
        ...
        <div class="adm-modal-body">
            <div class="sa-form-grid" style="grid-template-columns:1fr;">
                <div class="sa-form-group">
                    ...
                    <input class="adm-input" id="newCode" type="text" placeholder="${superadminPermissionsFormCodePlaceholderMsg}" style="text-transform:uppercase;">
                </div>
                <div class="sa-form-group">
                    <label class="sa-form-label"><spring:message code="superAdmin.permissions.form.displayName"/> <span style="color:#ef4444;">*</span></label>
                    <input class="adm-input" id="newName" type="text" placeholder="${superadminPermissionsFormDisplayNamePlaceholderMsg}">
                </div>
                <div class="sa-form-group">
                    <label class="sa-form-label"><spring:message code="superAdmin.permissions.form.description"/></label>
                    <input class="adm-input" id="newDesc" type="text" placeholder="${superadminPermissionsFormDescriptionPlaceholderMsg}">
                </div>
            </div>
        </div>
    ...
    <div class="adm-modal" style="width:560px;max-width:95vw;">
        ...
        <div class="adm-modal-body">
            ...
            <div style="display:flex;gap:8px;margin-bottom:10px;">
                <input class="adm-input" id="adminSearchInput" type="text" placeholder="${superadminPermissionsModalAdminSearchPlaceholderMsg}" style="flex:1;"
...
const PERMISSION_MESSAGES = {
    required: '${superadminPermissionsToastRequiredMsg}',
    createFailed: '${superadminPermissionsToastCreateFailedMsg}',
    created: '${superadminPermissionsToastCreatedMsg}',
    confirmActivate: '${superadminPermissionsConfirmActivateMsg}',
    confirmDeactivate: '${superadminPermissionsConfirmDeactivateMsg}',
    updated: '${superadminPermissionsToastUpdatedMsg}',
    updateFailed: '${superadminPermissionsToastUpdateFailedMsg}',
    confirmDeleteEmpty: '${superadminPermissionsConfirmDeleteEmptyMsg}',
    confirmDeleteWithUsage: '${superadminPermissionsConfirmDeleteWithUsageMsg}',
    deleted: '${superadminPermissionsToastDeletedMsg}',
    deleteFailed: '${superadminPermissionsToastDeleteFailedMsg}',
    detailSuffix: '${superadminPermissionsModalDetailTitleSuffixMsg}',
    noGroups: '${superadminPermissionsNoGroupsMsg}',
    noTemplates: '${superadminPermissionsNoTemplatesMsg}',
    noAdmins: '${superadminPermissionsNoAdminsMsg}',
    revokeAction: '${superadminPermissionsActionRevokeMsg}',
    searchRequired: '${superadminPermissionsToastSearchRequiredMsg}',
    searchEmpty: '${superadminPermissionsSearchEmptyMsg}',
    grantAction: '${superadminPermissionsActionGrantMsg}',
    confirmGrantAdmin: '${superadminPermissionsConfirmGrantAdminMsg}',
    granted: '${superadminPermissionsToastGrantedMsg}',
    grantFailed: '${superadminPermissionsToastGrantFailedMsg}',
    confirmRevokeAdmin: '${superadminPermissionsConfirmRevokeAdminMsg}',
    revoked: '${superadminPermissionsToastRevokedMsg}',
    revokeFailed: '${superadminPermissionsToastRevokeFailedMsg}'
};
