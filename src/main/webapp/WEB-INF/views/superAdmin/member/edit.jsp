...
<spring:message var="superadminMemberEditPlaceholderResponsibilityMsg" code="superAdmin.member.edit.placeholder.responsibility"/>
<spring:message var="superadminMemberEditPlaceholderPermissionDescriptionMsg" code="superAdmin.member.edit.placeholder.permissionDescription"/>
<spring:message var="superadminMemberEditToastSavedMsg" code="superAdmin.member.edit.toast.saved" javaScriptEscape="true"/>
<spring:message var="superadminMemberEditToastSaveFailedMsg" code="superAdmin.member.edit.toast.saveFailed" javaScriptEscape="true"/>
<spring:message var="superadminMemberEditToastSaveErrorMsg" code="superAdmin.member.edit.toast.saveError" javaScriptEscape="true"/>
<spring:message var="superadminMemberEditToastGroupRequiredMsg" code="superAdmin.member.edit.toast.groupRequired" javaScriptEscape="true"/>
<spring:message var="superadminMemberEditConfirmApplyGroupMsg" code="superAdmin.member.edit.confirm.applyGroup" javaScriptEscape="true"/>
<spring:message var="superadminMemberEditToastGroupEmptyMsg" code="superAdmin.member.edit.toast.groupEmpty" javaScriptEscape="true"/>
<spring:message var="superadminMemberEditToastGroupAppliedMsg" code="superAdmin.member.edit.toast.groupApplied" javaScriptEscape="true"/>
<spring:message var="superadminMemberEditToastApplyFailedMsg" code="superAdmin.member.edit.toast.applyFailed" javaScriptEscape="true"/>
<spring:message var="superadminMemberEditToastErrorMsg" code="superAdmin.member.edit.toast.error" javaScriptEscape="true"/>
                    ...
                    <div class="sa-form-grid">
                        <div class="sa-form-group" style="grid-column:1/-1;">
                            ...
                            <input class="adm-input" type="text" name="adminResponsibility" form="editForm"
                                   ...
                                   placeholder="${superadminMemberEditPlaceholderResponsibilityMsg}">
                        </div>
                        <div class="sa-form-group" style="grid-column:1/-1;">
                            ...
                            <input class="adm-input" type="text" name="adminPermission" form="editForm"
                                   ...
                                   placeholder="${superadminMemberEditPlaceholderPermissionDescriptionMsg}">
                        </div>
                        <div class="sa-form-group">
...
var MEMBER_EDIT_MESSAGES = {
    saved: '${superadminMemberEditToastSavedMsg}',
    saveFailed: '${superadminMemberEditToastSaveFailedMsg}',
    saveError: '${superadminMemberEditToastSaveErrorMsg}',
    groupRequired: '${superadminMemberEditToastGroupRequiredMsg}',
    confirmApplyGroup: '${superadminMemberEditConfirmApplyGroupMsg}',
    groupEmpty: '${superadminMemberEditToastGroupEmptyMsg}',
    groupApplied: '${superadminMemberEditToastGroupAppliedMsg}',
    applyFailed: '${superadminMemberEditToastApplyFailedMsg}',
    error: '${superadminMemberEditToastErrorMsg}'
};
