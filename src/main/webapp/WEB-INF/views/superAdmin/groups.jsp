...
<spring:message var="superadminGroupsFormGroupCodePlaceholderMsg" code="superAdmin.groups.form.groupCodePlaceholder"/>
<spring:message var="superadminGroupsFormDisplayNamePlaceholderMsg" code="superAdmin.groups.form.displayNamePlaceholder"/>
<spring:message var="superadminGroupsFormDescriptionPlaceholderMsg" code="superAdmin.groups.form.descriptionPlaceholder"/>
<spring:message var="superadminGroupsModalMemberSearchPlaceholderMsg" code="superAdmin.groups.modal.memberSearchPlaceholder"/>
<spring:message var="superadminGroupsToastRequiredMsg" code="superAdmin.groups.toast.required" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastCreateFailedMsg" code="superAdmin.groups.toast.createFailed" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastCreatedMsg" code="superAdmin.groups.toast.created" javaScriptEscape="true"/>
<spring:message var="superadminGroupsConfirmActivateMsg" code="superAdmin.groups.confirm.activate" javaScriptEscape="true"/>
<spring:message var="superadminGroupsConfirmDeactivateMsg" code="superAdmin.groups.confirm.deactivate" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastUpdatedMsg" code="superAdmin.groups.toast.updated" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastUpdateFailedMsg" code="superAdmin.groups.toast.updateFailed" javaScriptEscape="true"/>
<spring:message var="superadminGroupsModalDetailTitleSuffixMsg" code="superAdmin.groups.modal.detailTitleSuffix" javaScriptEscape="true"/>
<spring:message var="superadminGroupsLoadingMsg" code="superAdmin.groups.loading" javaScriptEscape="true"/>
<spring:message var="superadminGroupsNoPermissionsMsg" code="superAdmin.groups.noPermissions" javaScriptEscape="true"/>
<spring:message var="superadminGroupsNoMembersMsg" code="superAdmin.groups.noMembers" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastSearchRequiredMsg" code="superAdmin.groups.toast.searchRequired" javaScriptEscape="true"/>
<spring:message var="superadminGroupsSearchEmptyMsg" code="superAdmin.groups.searchEmpty" javaScriptEscape="true"/>
<spring:message var="superadminGroupsActionAddMsg" code="superAdmin.groups.action.add" javaScriptEscape="true"/>
<spring:message var="superadminGroupsActionRemoveMsg" code="superAdmin.groups.action.remove" javaScriptEscape="true"/>
<spring:message var="superadminGroupsConfirmAddMemberMsg" code="superAdmin.groups.confirm.addMember" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastMemberAddedMsg" code="superAdmin.groups.toast.memberAdded" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastMemberAddFailedMsg" code="superAdmin.groups.toast.memberAddFailed" javaScriptEscape="true"/>
<spring:message var="superadminGroupsConfirmRemoveMemberMsg" code="superAdmin.groups.confirm.removeMember" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastMemberRemovedMsg" code="superAdmin.groups.toast.memberRemoved" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastMemberRemoveFailedMsg" code="superAdmin.groups.toast.memberRemoveFailed" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastPermissionRequiredMsg" code="superAdmin.groups.toast.permissionRequired" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastPermissionAddedMsg" code="superAdmin.groups.toast.permissionAdded" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastPermissionAddFailedMsg" code="superAdmin.groups.toast.permissionAddFailed" javaScriptEscape="true"/>
<spring:message var="superadminGroupsConfirmRemovePermissionMsg" code="superAdmin.groups.confirm.removePermission" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastPermissionRemovedMsg" code="superAdmin.groups.toast.permissionRemoved" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastPermissionRemoveFailedMsg" code="superAdmin.groups.toast.permissionRemoveFailed" javaScriptEscape="true"/>
<spring:message var="superadminGroupsConfirmDeleteEmptyMsg" code="superAdmin.groups.confirm.deleteEmpty" javaScriptEscape="true"/>
<spring:message var="superadminGroupsConfirmDeleteWithMembersMsg" code="superAdmin.groups.confirm.deleteWithMembers" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastDeletedMsg" code="superAdmin.groups.toast.deleted" javaScriptEscape="true"/>
<spring:message var="superadminGroupsToastDeleteFailedMsg" code="superAdmin.groups.toast.deleteFailed" javaScriptEscape="true"/>
<spring:message var="superadminGroupsListItemCountMsg" code="superAdmin.groups.list.itemCount" javaScriptEscape="true"/>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <div class="sa-group-row ${g.active ? '' : 'sa-group-inactive'}">
                        ...
                        <div class="sa-group-cnt"><spring:message code="superAdmin.groups.list.itemCount"/></div>
                        <div>
                            <c:choose>
        ...
        <div class="adm-modal-body">
            <div class="sa-form-grid" style="grid-template-columns:1fr;">
                <div class="sa-form-group">
                    ...
                    <input class="adm-input" id="newGroupCode" type="text" placeholder="${superadminGroupsFormGroupCodePlaceholderMsg}" style="text-transform:uppercase;">
                </div>
                <div class="sa-form-group">
                    <label class="sa-form-label"><spring:message code="superAdmin.groups.form.displayName"/> <span style="color:#ef4444;">*</span></label>
                    <input class="adm-input" id="newGroupName" type="text" placeholder="${superadminGroupsFormDisplayNamePlaceholderMsg}">
                </div>
                <div class="sa-form-group">
                    <label class="sa-form-label"><spring:message code="superAdmin.groups.form.description"/></label>
                    <input class="adm-input" id="newGroupDesc" type="text" placeholder="${superadminGroupsFormDescriptionPlaceholderMsg}">
                </div>
            </div>
        </div>
    ...
    <div class="adm-modal" style="width:560px;max-width:95vw;">
        ...
        <div class="adm-modal-body">
            ...
            <div style="display:flex;gap:8px;margin-bottom:10px;">
                <input class="adm-input" id="memberSearchInput" type="text" placeholder="${superadminGroupsModalMemberSearchPlaceholderMsg}" style="flex:1;"
...
const GROUP_MESSAGES = {
    required: '${superadminGroupsToastRequiredMsg}',
    createFailed: '${superadminGroupsToastCreateFailedMsg}',
    created: '${superadminGroupsToastCreatedMsg}',
    confirmActivate: '${superadminGroupsConfirmActivateMsg}',
    confirmDeactivate: '${superadminGroupsConfirmDeactivateMsg}',
    updated: '${superadminGroupsToastUpdatedMsg}',
    updateFailed: '${superadminGroupsToastUpdateFailedMsg}',
    detailSuffix: '${superadminGroupsModalDetailTitleSuffixMsg}',
    loading: '${superadminGroupsLoadingMsg}',
    noPermissions: '${superadminGroupsNoPermissionsMsg}',
    noMembers: '${superadminGroupsNoMembersMsg}',
    searchRequired: '${superadminGroupsToastSearchRequiredMsg}',
    searchEmpty: '${superadminGroupsSearchEmptyMsg}',
    addAction: '${superadminGroupsActionAddMsg}',
    removeAction: '${superadminGroupsActionRemoveMsg}',
    confirmAddMember: '${superadminGroupsConfirmAddMemberMsg}',
    memberAdded: '${superadminGroupsToastMemberAddedMsg}',
    memberAddFailed: '${superadminGroupsToastMemberAddFailedMsg}',
    confirmRemoveMember: '${superadminGroupsConfirmRemoveMemberMsg}',
    memberRemoved: '${superadminGroupsToastMemberRemovedMsg}',
    memberRemoveFailed: '${superadminGroupsToastMemberRemoveFailedMsg}',
    permissionRequired: '${superadminGroupsToastPermissionRequiredMsg}',
    permissionAdded: '${superadminGroupsToastPermissionAddedMsg}',
    permissionAddFailed: '${superadminGroupsToastPermissionAddFailedMsg}',
    confirmRemovePermission: '${superadminGroupsConfirmRemovePermissionMsg}',
    permissionRemoved: '${superadminGroupsToastPermissionRemovedMsg}',
    permissionRemoveFailed: '${superadminGroupsToastPermissionRemoveFailedMsg}',
    confirmDeleteEmpty: '${superadminGroupsConfirmDeleteEmptyMsg}',
    confirmDeleteWithMembers: '${superadminGroupsConfirmDeleteWithMembersMsg}',
    deleted: '${superadminGroupsToastDeletedMsg}',
    deleteFailed: '${superadminGroupsToastDeleteFailedMsg}',
    itemCount: '${superadminGroupsListItemCountMsg}'
};
