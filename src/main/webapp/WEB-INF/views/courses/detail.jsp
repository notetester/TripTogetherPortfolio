...
<spring:message var="coursesCommonFieldCitySelectMsg" code="courses.common.field.citySelect" javaScriptEscape="true"/>
...
<script>
    ...
    const courseDetailMessages = {
        ...
        citySelectLabel: "${coursesCommonFieldCitySelectMsg}",
