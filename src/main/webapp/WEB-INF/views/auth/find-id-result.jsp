  ...
  <div class="auth-card" style="text-align:center;">
    ...
    <c:choose>
      <c:when test="${not empty foundUserId}">
        ...
        <h1 class="auth-title"><spring:message code="auth.findIdResult.foundTitle"/></h1>
        <p class="auth-sub"><spring:message code="auth.findIdResult.foundSubtitle"/></p>
      ...
      <c:otherwise>
        <div style="font-size:56px;margin:16px 0 20px;">⏰</div>
        <h1 class="auth-title"><spring:message code="auth.findIdResult.expiredTitle"/></h1>
