...
<spring:message var="communityDetailCommentPlaceholderMsg" code="community.detail.comment.placeholder"/>
<spring:message var="communitySearchPlaceholderMsg" code="community.search.placeholder"/>
<spring:message var="communityDetailCommentsCloseMsg" code="community.detail.comments.close" javaScriptEscape="true"/>
<spring:message var="communityDetailCommentsOpenMsg" code="community.detail.comments.open" javaScriptEscape="true"/>
...
<spring:message var="communityDetailCommentsBlockUserMsg" code="community.detail.comments.block.user" javaScriptEscape="true"/>
<spring:message var="communityDetailCommentsBlockIpMsg" code="community.detail.comments.block.ip" javaScriptEscape="true"/>
<spring:message var="communityDetailCommentsBlockBothMsg" code="community.detail.comments.block.both" javaScriptEscape="true"/>
<spring:message var="communityDetailCommentsBlockDeleteUserMsg" code="community.detail.comments.blockDelete.user" javaScriptEscape="true"/>
<spring:message var="communityDetailCommentsBlockDeleteIpMsg" code="community.detail.comments.blockDelete.ip" javaScriptEscape="true"/>
<spring:message var="communityDetailCommentsBlockDeleteBothMsg" code="community.detail.comments.blockDelete.both" javaScriptEscape="true"/>
  ...
  <section class="detail-comment-section">
      ...
      <div class="comm-comment-toolbar" id="commentToolbarTop">
        <div class="comm-toolbar-left">
          <span class="comm-comment-total"><spring:message code="community.detail.comments.total"/></span>
          ...
          <c:when test="${not empty sessionScope.loginUser}">
            <div class="comment-input-box">
              <textarea class="comment-textarea" id="commentText"
                        placeholder="${communityDetailCommentPlaceholderMsg}" rows="3"
...
var COMMENT_CLOSE_LABEL = '${communityDetailCommentsCloseMsg}';
var COMMENT_OPEN_LABEL = '${communityDetailCommentsOpenMsg}';
var COMMUNITY_SELECTED_TEMPLATE = '${communityAdminSelectedMsg}';
var COMMUNITY_ACTION_LABELS = {
  delete: '${communityAdminDeleteMsg}',
  blockUser: '${communityDetailCommentsBlockUserMsg}',
  blockIp: '${communityDetailCommentsBlockIpMsg}',
  blockBoth: '${communityDetailCommentsBlockBothMsg}',
  blockUserAndDelete: '${communityDetailCommentsBlockDeleteUserMsg}',
  blockIpAndDelete: '${communityDetailCommentsBlockDeleteIpMsg}',
  blockAndDelete: '${communityDetailCommentsBlockDeleteBothMsg}'
};
  ...
  <div style="background:#fff;border-radius:16px;padding:28px 32px;min-width:320px;max-width:460px;width:90%;box-shadow:0 8px 32px rgba(0,0,0,.18);">
    ...
    <div style="margin-bottom:20px;">
      ...
      <textarea id="rptDescription" rows="4"
                placeholder="${communityDetailReportDescriptionPlaceholderMsg}"
  ...
  <div style="background:#fff;border-radius:16px;padding:28px 32px;min-width:320px;max-width:460px;width:90%;box-shadow:0 8px 32px rgba(0,0,0,.18);">
    ...
    <div style="margin-bottom:20px;">
      <textarea id="rptUserDescription" rows="5"
                placeholder="${communityDetailUserReportPlaceholderMsg}"
                style="width:100%;box-sizing:border-box;padding:10px 12px;border:1px solid var(--gray-200);border-radius:8px;font-family:inherit;font-size:14px;color:var(--gray-800);outline:none;resize:vertical;"></textarea>
